...
<body>
    ...
    <div class="dashboard-layout">
        <aside class="sidebar">
            <div class="sidebar-header"><img src="assets/images/profile-pic.png" alt="Profile" class="profile-pic"><h4><?php echo htmlspecialchars($receiver_name); ?></h4><p class="user-role">Receiver Account</p></div>
